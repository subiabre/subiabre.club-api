...
use App\Doctrine\Photo\ItemLocationFilter;
use App\Doctrine\Photo\ItemPersonFilter;
use App\Repository\Photo\PhotoItemRepository;
...
#[API\ApiFilter(
    filterClass: ItemLocationFilter::class,
    properties: ['location']
)]
#[API\ApiFilter(
    filterClass: ItemPersonFilter::class,
    properties: ['person']
)]
#[API\ApiFilter(
